...
A transient card anchored to the exact in-text figure, table, or code reference.
...
is over the reference or card, and closes shortly after leaving both. Equivalent
source and Korean reference tokens open the same preserved asset without a
...
or `Listing 4`, including its localized equivalent, that uniquely identifies
the asset shown by a reference preview.
